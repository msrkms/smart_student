...
public class info_subject extends javax.swing.JFrame {
    private String CourseCode;
  
    public info_subject(String CourseCode) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Routine Information By Subject");
        ...
        jPanel1.add(CourseCodeLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 80, 70, -1));

        jLabel32.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel32.setText("Subject Code :");
        jPanel1.add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 80, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(info_subject.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new info_subject().setVisible(true);
            }
        });
    }
