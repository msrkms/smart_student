...
public class reminderdelete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Delete Reminder Information");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int success=deletereminder.delete();
        if(success!=0){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(reminderdelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
