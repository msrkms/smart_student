...
public class routineedit extends javax.swing.JFrame {
    ...
    public routineedit(String CourseCode) {
        initComponents();
    ...
    private void initComponents() {
        ...
        routinetable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Day", "Room", "Start Time", "End Time", "Class Type"
            }
        ) {
        ...
        jPanel1.add(Editbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 460, 130, -1));

        jLabel32.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel32.setText("Subject Code :");
        jPanel1.add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 80, -1, -1));
    ...
    private void EditbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditbtnActionPerformed
        ...
        if(row<0){
            JOptionPane.showMessageDialog(null, "Please Seletect a Row");
        }else{
        ...
        String ClassType=table.getValueAt(row, 4).toString();
        EditRoutine ebs = new EditRoutine(CourseCode,Day,StartTime, RoomNo, ClassType);
        ebs.setVisible(true);
        this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(routineedit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new routineedit().setVisible(true);
            }
        });
    }
